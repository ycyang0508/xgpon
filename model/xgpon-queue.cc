...
XgponQueue::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::XgponQueue")
    ...
    .AddTraceSource ("Enqueue", "Enqueue a packet in the queue.",
                     MakeTraceSourceAccessor (&XgponQueue::m_traceEnqueue),"ns3::QueueDiscItem::TracedCallback")
    .AddTraceSource ("Dequeue", "Dequeue a packet from the queue.",
                     MakeTraceSourceAccessor (&XgponQueue::m_traceDequeue),"ns3::QueueDiscItem::TracedCallback")
    .AddTraceSource ("Drop", "Drop a packet stored in the queue.",
                     MakeTraceSourceAccessor (&XgponQueue::m_traceDrop),"ns3::QueueDiscItem::TracedCallback")
  ;
  return tid;
}
TypeId
