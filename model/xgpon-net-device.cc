...
XgponNetDevice::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::XgponNetDevice")
    ...
    .AddTraceSource ("Enqueue", "Enqueue a packet in the virtual per-device queue.",
                     MakeTraceSourceAccessor (&XgponNetDevice::m_traceEnqueueVirtual),"ns3::QueueDiscItem::TracedCallback")
    .AddTraceSource ("Dequeue", "Dequeue a packet from the virtual per-device queue.",
                     MakeTraceSourceAccessor (&XgponNetDevice::m_traceDequeueVirtual),"ns3::QueueDiscItem::TracedCallback")
    .AddTraceSource ("Drop", "Drop a packet stored in the virtual per-device queue.",
                     MakeTraceSourceAccessor (&XgponNetDevice::m_traceDropVirtual),"ns3::QueueDiscItem::TracedCallback")
    ...
    .AddTraceSource ("Sniffer", 
                     ...
                     MakeTraceSourceAccessor (&XgponNetDevice::m_snifferTrace),"ns3::Packet::TracedCallback")
    .AddTraceSource ("PromiscSniffer", 
                     "Trace source simulating a promiscuous packet sniffer attached to the device",
                     MakeTraceSourceAccessor (&XgponNetDevice::m_promiscSnifferTrace),"ns3::Packet::TracedCallback")

    .AddTraceSource ("DeviceStatistics", "Trace sources for the whole network device statistics",
                     MakeTraceSourceAccessor (&XgponNetDevice::m_deviceStatisticsTrace),"ns3::Packet::TracedCallback")
