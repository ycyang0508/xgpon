...
XgponOnuNetDevice::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::XgponOnuNetDevice")
    ...
    .AddTraceSource ("PhyTxEnd",
        ...
        MakeTraceSourceAccessor (&XgponOnuNetDevice::m_phyTxEndTrace),"ns3::Packet::TracedCallback")
    .AddTraceSource ("PhyRxEnd",
        "Trace source indicating a packet has been completely received by the device",
        MakeTraceSourceAccessor (&XgponOnuNetDevice::m_phyRxEndTrace),"ns3::Packet::TracedCallback")
  ;
  return tid;
}
TypeId
