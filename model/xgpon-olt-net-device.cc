...
XgponOltNetDevice::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::XgponOltNetDevice")
    ...
    .AddTraceSource ("PhyTxEnd",
        ...
        MakeTraceSourceAccessor (&XgponOltNetDevice::m_phyTxEndTrace), "ns3::Packet::TracedCallback")
    .AddTraceSource ("PhyRxEnd",
        "Trace source indicating a packet has been completely received by the device",
        MakeTraceSourceAccessor (&XgponOltNetDevice::m_phyRxEndTrace),  "ns3::Packet::TracedCallback")
